...
CREATE TABLE SKILL (
	...
	CONSTRAINT FK_SKILL_MEMBER FOREIGN KEY(EMAIL) REFERENCES MEMBER ON DELETE CASCADE,
...
ALTER TABLE REVIEW
	ADD
		CONSTRAINT FK_SITTER_TO_REVIEW
		FOREIGN KEY (
			EMAIL2
		)
		REFERENCES SITTER (
...
ALTER TABLE RESERVATION
	ADD
		CONSTRAINT FK_SITTER_TO_RESERVATION
		FOREIGN KEY (
			EMAIL2
		)
		REFERENCES SITTER (
...
ALTER TABLE DEMAND
	DROP
		CONSTRAINT FK_RESERVATION_TO_DEMAND
		CASCADE;
-- 코드에 대한 외래키 삭제
ALTER TABLE DEMAND
	DROP
		CONSTRAINT FK_CODE_TO_DEMAND
		CASCADE;
