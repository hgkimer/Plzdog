		...
		<div class="col-lg-6">
			<div class="row">
				<c:if test="${empty requestScope.memberList }">
					<h2 style="color: tomato; text-align: center;">결제 대기중인 예약이
						없습니다!</h2>
							...
							<div class="collapse" id="${res.resId }">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										...
										<ol>
											<c:forEach items="${res.demandList }" var="demand">
												<li><strong>${demand.code.codeName } <span
														class="glyphicon glyphicon-ok"></span></strong></li>
											</c:forEach>
										</ol>
									</div>
								</div>
									...
									<div class="row">
										<div class="col-lg-4">
											...
											<c:forEach items="${resDetail.dog.dogImage }" var="dogImage">
												<img class="img-circle" style="width: 200px" alt="강아지 사진"
													src="${initParam.rootPath }/dogImage/${dogImage.dogImage}">
											</c:forEach>
										</div>
										...
										<div class="col-lg-4">
											...
											<p>
												<strong><span class="glyphicon glyphicon-search"></span>${resDetail.dog.dogName }</strong>
											</p>
											<hr>
											<p>
												<strong><span class="glyphicon glyphicon-filter"></span>${resDetail.dog.species }</strong>
											</p>
											<p>
												<strong><span class="glyphicon glyphicon-heart"></span>${resDetail.dog.gender }</strong>
											</p>
											<p>
												<strong>무게 ${resDetail.dog.weight }kg</strong>
											</p>
											<p>
												<strong><span class="glyphicon glyphicon-gift"></span>
													<fmt:formatDate value="${resDetail.dog.birth }"
										...
										<div class="col-lg-4">
											...
											<span class="glyphicon glyphicon-th-list"></span><label>강아지
												상세 정보</label><br>
											<c:forEach items="${resDetail.dog.dogInfoList }"
												var="dogInfo">
												<ol>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<span class="glyphicon glyphicon-th-list"></span><label>보유
											능력 리스트</label><br>
										<ol>
											<c:forEach items="${res.sitter.sitter.skillList }"
												var="skill">
												<c:if test="${fn:contains(skill.code.category, '시터')}">
													<li><strong>${skill.code.codeName } <span
															class="glyphicon glyphicon-ok"></span></strong></li>
												</c:if>
											</c:forEach>
										</ol>
