...
<link rel="stylesheet" href="${initParam.rootPath }/resource/bootstrap/css/bootstrap-datetimepicker.min.css"/>
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/timepicker/1.3.5/jquery.timepicker.min.js"></script>
<script type="text/javascript" src="${initParam.rootPath }/resource/bootstrap/js/resource/bootstrap/js/bootstrap-datetimepicker.min.js"></script>
	...
	<div class="col-lg-12">
		...
		<form action="${initParam.rootPath }/member/reservation_add.do" method="post" id="reservationForm" >
			...
			<div class="form-group">
				...
				<select name="demand" id="serviceSel" required class="form-control">
