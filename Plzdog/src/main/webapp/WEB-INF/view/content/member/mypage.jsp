...
<div class="two">
	<div class="mypage-form" style="margin-left:20px;">
		...
		<form action="${initParam.rootPath }/sitter/waiting_payment_reservation_result.do" method="post" class="member-form">
			<sec:csrfInput/>
			<input type="hidden" name="sitterEmail" value='<sec:authentication property="principal.email"/>'/>
			<button type="submit" class="btn-primary">결제가 대기중인 예약 조회(시터)</button>
		</form>
